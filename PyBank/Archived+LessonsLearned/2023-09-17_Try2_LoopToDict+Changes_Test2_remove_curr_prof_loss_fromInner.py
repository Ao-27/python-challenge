...
#LOOKS LIKE correcting to "0" below has FIXED the script ... 
          ...
          if (count == 1):
               ...
               prior_row_prof_loss = 0 #+ curr_row_prof_loss  ##REMOVING ... this might be the "confusion" ... in the codes loop ... 
...
#               Records_forAnalysis.update({str("Prior_Row_Profit_Loss"):prior_row_prof_loss})
     ...
     #FAILED#TEST1 via total months ... to see if prior row prof+loss needs to be removed from INNER CODE ...
