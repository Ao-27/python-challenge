...
original_location = #NOTE this is the "sourcePath" for G for Geeks.
target_location =   #NOTE this is the "destinationPath" for G for Geeks.
...
#    shutil.move(src_folder + file_name, new_name)
    destination = shutil.move(original_location + output1_file_name, new_name)
else:
    destination = shutil.move(original_location + output1_file_name, target_location + output1_file_name)
