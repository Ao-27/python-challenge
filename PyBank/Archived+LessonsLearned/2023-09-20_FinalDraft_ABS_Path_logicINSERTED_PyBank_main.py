...
#Move create file to "Analysis" folder directory. via URL => https://datatofish.com/move-file-python/ & https://pynative.com/python-move-files/
import shutil

original_location = validated_current_dir
#target_location = 
