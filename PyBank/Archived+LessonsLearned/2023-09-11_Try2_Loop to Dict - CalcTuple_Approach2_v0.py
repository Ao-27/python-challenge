...
print("--------")
for prev,curr in zip(Prev_Curr_Nxt_RollTotal_v2, Prev_Curr_Nxt_RollTotal_v2[1:]) #,nxt in zip(Prev_Curr_Nxt_RollTotal_v2, Prev_Curr_Nxt_RollTotal_v2[1:]) #, Prev_Curr_Nxt_RollTotal_v2[2:]):
     print(prev,curr) #,nxt)
...
#ATTEMPTING the "iterating by index can do the same thing:" comment response ... 

#for i in range(Calc_Range + 1):  #- 1): #neg1 NOT needed or working correctly ... because of ... enumerate +1 above I suspect ...  #ACTUALLY ... the neg1 ... is needed or the code WON'T RUN ... 
#     prev_i, curr_i = Calculation_RollTotal_Tuple[i], Calculation_RollTotal_Tuple[i + 1]
#     print(prev_i, curr_i)
#     print("--")
#print("end_of Prev+Curr Loop")
