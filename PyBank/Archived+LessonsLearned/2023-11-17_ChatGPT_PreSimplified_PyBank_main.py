...
#USING CHAT GPT ... to summarize this .py script ... here's the prompt below ... 

#hi chat gpt would you be able to simplify a .py file to normalize and/or simplify the comments that start with "#" and suggest new variables that are in front of the "=". I will provide the .py code script next.

#WIll archive this copy ... review for alignment to rubrik marking ... and "just submit it" ... shutil move issues can be "future fixes" ... as a mini project perhaps?? 

#++++++

##PY_BANK JUST NEEDS A "CODE CLEANSE" ... TO DELETE ALL MY PERS NOTES ... 
...
#0> https://www.geeksforgeeks.org/python-os-scandir-method/    ## LOOKS LIKE what I truly needed for my "older approaches" ... not os.walk() but .... os.scandir()...
